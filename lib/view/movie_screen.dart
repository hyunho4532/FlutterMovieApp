...
class MovieScreen extends StatefulWidget {
  MovieScreen({Key? key, required this.themeNotifier}) : super(key: key);
                      ...
                      if (isLoading) {
                        ...
                        return SizedBox (
                          ...
                          child: Expanded (
                            child: ListView (
                              children: [
                                TV(tv: tv, themeNotifier: widget.themeNotifier),
                                TopRated(topRated: topRatedMovies, themeNotifier: widget.themeNotifier),
                                TrendingMovies(trending: trendingmovies, themeNotifier: widget.themeNotifier),
